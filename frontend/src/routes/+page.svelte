    ...
    <div class="grid grid-cols-2 gap-10">
        {#each list as item, idx}
            <div class="flex flex-col">
                <div class="flex min-h-72 items-center justify-center bg-slate-200">사진</div>
                <div>
...
<footer class="sticky bottom-0 flex h-16 w-full items-center justify-around border-t-[1px] bg-white">
